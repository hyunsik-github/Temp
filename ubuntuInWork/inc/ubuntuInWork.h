#ifndef _UBUNTUINWORK_H_
#define _UBUNTUINWORK_H_
...
/**
 * [ubuntuInWork] UiApp must inherit from UiApp class
 * which provides basic features necessary to define an UiApp.
 */
class ubuntuInWorkApp
...
public:
	ubuntuInWorkApp(void);
	virtual ~ubuntuInWorkApp(void);
